...
object Toasty {
    ...
    fun info(
        ...
        return custom(
            ...
            icon = infoIcon,
            tintColor = context.color(R.color.theme_colorful_3F51B5),
            textColor = context.color(R.color.theme_colorful_white),
    ...
    fun warning(
        ...
        return custom(
            ...
            message = context.getString(message),
            icon = warningIcon,
            tintColor = context.color(R.color.theme_colorful_FFA900),
            textColor = context.color(R.color.theme_colorful_white),
    ...
    fun success(
        ...
        return custom(
            ...
            message = context.getString(message),
            icon = successIcon,
            tintColor = context.color(R.color.theme_colorful_388E3C),
            textColor = context.color(R.color.theme_colorful_white),
    ...
    fun error(
        ...
        return custom(
            ...
            message = context.getString(message),
            icon = errorIcon,
            tintColor = context.color(R.color.theme_colorful_D50000),
            textColor = context.color(R.color.theme_colorful_white),
    ...
    private fun withLightTheme(
        ...
        return custom(
            ...
            message = message,
            icon = icon,
            tintColor = context.color(R.color.theme_colorful_white),
            textColor = context.color(R.color.theme_colorful_353A3E),
            duration = duration,
            withIcon = icon != null,
            shouldTint = true,
        )
    ...
    private fun withDarkTheme(
        ...
        return custom(
            ...
            message = message,
            icon = icon,
            tintColor = context.color(R.color.theme_colorful_353A3E),
            textColor = context.color(R.color.theme_colorful_white),
            duration = duration,
            withIcon = icon != null,
            shouldTint = true,
